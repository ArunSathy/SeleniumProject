...
for i in groups:
    ...
    # adding attachment segment in the code

    # attachment button clicking

    attachment_add_xpath = '//*[@id="main"]/footer/div[1]/div/span[2]/div/div[1]/div[2]/div/div/div/span'
    attachment_add=brw.find_element(By.XPATH,attachment_add_xpath)
    attachment_add.click()

    # selecting the image

    image_box_xpath='//*[@id="main"]/footer/div[1]/div/span[2]/div/div[1]/div[2]/div/span/div/ul/div/div[2]/li/div/span'
    image_box=brw.find_element(By.XPATH,image_box_xpath)
    image_box.send_keys('C:\\Users\\arhsathy\\Pictures\\me.jpeg')  # Having a error with this line, the image is not fetching, wants to figure it out !!

    # clicking the send button

    send_button_xpath = '//*[@id="app"]/div/div[2]/div[2]/div[2]/span/div/span/div/div/div[2]/div/div[2]/div[2]/div/div'
    send_button=brw.find_element(By.XPATH,send_button_xpath)
    send_button.click()
